...
RSpec.feature 'Post Index Page' do
  ...
  let!(:post2) do
    Post.create(author_id: user1.id, title: 'My second Post', text: 'I am failing integration specs', comments_counter: 0,
                likes_counter: 0)
  end
  let!(:post3) do
    Post.create(author_id: user1.id, title: 'My third Post', text: 'I am finishing integration specs',
                comments_counter: 0, likes_counter: 0)
  end
  let!(:post4) do
    Post.create(author_id: user1.id, title: 'My forth Post', text: 'I finished integration specs', comments_counter: 0,
                likes_counter: 0)
  end
